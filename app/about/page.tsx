      ...
      <main>
        ...
        <section className="pt-24 pb-12 sm:pt-32 sm:pb-16 bg-gradient-to-br from-background via-primary/20 to-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-wider leading-tight mb-6 text-slate-700 dark:text-white">
                About
                <span className="block bg-gradient-to-r from-cyan-500 to-blue-700 dark:from-cyan-400 dark:to-blue-600 bg-clip-text text-transparent">
                  EastSecure
                </span>
              </h1>
              ...
              <Card className="bg-card/50 border border-border">
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2 text-2xl">
                    ...
                    <span className='text-slate-700 dark:text-white'>Our Mission</span>
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-card/50 border border-border">
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2 text-2xl">
                    ...
                    <span className='text-slate-700 dark:text-white'>Our Vision</span>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-lg leading-relaxed text-muted-foreground">
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4 text-slate-700 dark:text-white">
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        <h3 className="text-xl font-bold mb-1 text-slate-700 dark:text-white">{member.name}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {partnerships.map((partnership, index) => (
                <Card key={index} className="text-center bg-card/50 border border-border">
                  <CardHeader>
                    <CardTitle className="text-lg text-slate-700 dark:text-white">{partnership.name}</CardTitle>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-6 text-slate-700 dark:text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center space-y-2">
                  ...
                  <h3 className="font-semibold text-slate-700 dark:text-white">Data Protection</h3>
                  <p className="text-sm text-muted-foreground">Kenya DPA compliance</p>
                </div>
                <div className="text-center space-y-2">
                  <Globe className="h-8 w-8 text-blue-400 mx-auto" />
                  <h3 className="font-semibold text-slate-700 dark:text-white">Regional Cooperation</h3>
                ...
                <div className="text-center space-y-2">
                  ...
                  <h3 className="font-semibold text-slate-700 dark:text-white">International Standards</h3>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-t border-border">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-4 text-slate-700 dark:text-white">Partner with EastSecure Today</h2>
